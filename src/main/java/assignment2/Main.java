...
public class Main {
	public static void main(String[] args) {
		...
		RentalOrder order1 = new RentalOrder(individual1, car1, 3,rentalOffice);
		RentalOrder order2 = new RentalOrder(corporate1, suv1, 5, rentalOffice);
		...
		rentalOffice.addOrder(order1);//no need to have this command, as it is done by completeOrder above according to the given guidelines
