...
public class YardHandler implements handlerInterface{
    ...
    public void handle(Double distance, String unit) {
        distance = distance * 1760; //convert to mile 

        if (unit.equalsIgnoreCase("YARD")){ //if the user wants a mile output
